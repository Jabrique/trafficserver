...
// ─── Duplicate of is_valid_link_value from early_hints.cc ────────────────────
// The production code defines this as a file-static function in early_hints.cc,
// so we re-implement it here identically for integration verification.
static bool
